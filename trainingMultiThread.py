...
def readPosTripleToMat( ):
    ...
    global TRIPLE_SIZE, tripleIdxMatOrigin, posTriReady
    cnter = 0 
...
def readNegTripleToMat( ):
    ...
    global TRIPLE_SIZE, tripleIdxMatOrigin, negTriReady
    cnter = TRIPLE_SIZE
...
def main():
    ...
    tripleIdxMatOrigin = np.zeros([ 2 * TRIPLE_SIZE ,4 ], dtype = int)
